...
export default function RegistrationsPage() {
  // Mock data for attendees who filled out the external form
  const [attendees, setAttendees] = useState([
    { id: 1, name: "Liam Anderson", email: "liam.a@example.com", date: "Mar 12, 2026", status: "Pending QR" },
    { id: 2, name: "Emma Watson", email: "emma.w@example.com", date: "Mar 12, 2026", status: "QR Sent" },
    { id: 3, name: "Noah Carter", email: "noah.c@example.com", date: "Mar 13, 2026", status: "Pending QR" },
    { id: 4, name: "Olivia Martinez", email: "olivia.m@example.com", date: "Mar 13, 2026", status: "Pending QR" },
    { id: 5, name: "William Davis", email: "will.d@example.com", date: "Mar 13, 2026", status: "QR Sent" },
  ]);
  ...
  // Toggle select all pending attendees
  ...
  const sentCount = attendees.filter(a => a.status === "QR Sent").length;
